	...
	function convert( p ) {
		...
		if ( p === RGB_ETC2_Format || p === RGBA_ETC2_Format ) {
			...
			if (extension !== null) {
				...
				if ( p === RGBA_ETC2_Format_) return extension.COMPRESSED_RGBA8_ETC2_EAC;
			}
		}
